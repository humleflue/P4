...
public class BParser extends Parser {
	...
	public static class LogOrContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLogOr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LogAndContext extends LogexprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLogAnd(this);
			else return visitor.visitChildren(this);
		}
	}
