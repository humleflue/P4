...
public interface BuffVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code presedenceMath}
	 * labeled alternative in {@link BuffParser#val}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPresedenceMath(BuffParser.PresedenceMathContext ctx);
	/**
	 * Visit a parse tree produced by the {@code termTerminal}
	 * labeled alternative in {@link BuffParser#val}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTermTerminal(BuffParser.TermTerminalContext ctx);
	/**
	 * Visit a parse tree produced by {@link BuffParser#valTerminal}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitValTerminal(BuffParser.ValTerminalContext ctx);
	/**
