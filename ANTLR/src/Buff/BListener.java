...
public interface BListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterLogOr(BParser.LogOrContext ctx);
	/**
	 * Exit a parse tree produced by the {@code logOr}
	 * labeled alternative in {@link BParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitLogOr(BParser.LogOrContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterLogAnd(BParser.LogAndContext ctx);
	/**
	 * Exit a parse tree produced by the {@code logAnd}
	 * labeled alternative in {@link BParser#logexpr}.
	 * @param ctx the parse tree
	 */
	void exitLogAnd(BParser.LogAndContext ctx);
	/**
