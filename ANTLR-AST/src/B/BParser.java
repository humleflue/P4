...
public class BParser extends Parser {
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitProg(this);
	...
	public static class CodeEmptyContext extends CodeContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitCodeEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CodeStmtContext extends CodeContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitCodeStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CodeFuncdefContext extends CodeContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitCodeFuncdef(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FuncdefContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitFuncdef(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TypeContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitType(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FuncdefparamsEmptyContext extends FuncdefparamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitFuncdefparamsEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class FuncdefparamsNotEmptyContext extends FuncdefparamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitFuncdefparamsNotEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FuncdefmoreparamsNotEmptyContext extends FuncdefmoreparamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitFuncdefmoreparamsNotEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class FuncdefmoreparamsEmptyContext extends FuncdefmoreparamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitFuncdefmoreparamsEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FuncdefparamContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitFuncdefparam(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StmtsNotEmptyContext extends StmtsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitStmtsNotEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class StmtsEmptyContext extends StmtsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitStmtsEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StmtContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LogOrOpContext extends ExprContext {
		...
		public LogOrOpContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BListener ) ((BListener)listener).enterLogOrOp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BListener ) ((BListener)listener).exitLogOrOp(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLogOrOp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class LogContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLog(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new LogOrOpContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(97);
				((LogOrOpContext)_localctx).left = logexpr();
				setState(98);
				((LogOrOpContext)_localctx).op = match(LOGOR);
				setState(99);
				((LogOrOpContext)_localctx).right = expr();
				}
				break;
			case 2:
	...
	public static class LogAndOpContext extends LogexprContext {
		...
		public LogAndOpContext(LogexprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BListener ) ((BListener)listener).enterLogAndOp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BListener ) ((BListener)listener).exitLogAndOp(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLogAndOp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Log2Context extends LogexprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLog2(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final LogexprContext logexpr() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new LogAndOpContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(104);
				((LogAndOpContext)_localctx).left = logexpr2();
				setState(105);
				((LogAndOpContext)_localctx).op = match(LOGAND);
				setState(106);
				((LogAndOpContext)_localctx).right = logexpr();
				}
				break;
			case 2:
	...
	public static class LogEqualsOpContext extends Logexpr2Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLogEqualsOp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Log3Context extends Logexpr2Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLog3(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LogOpContext extends Logexpr3Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLogOp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MathContext extends Logexpr3Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitMath(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PlusMinusContext extends MathexprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitPlusMinus(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Math2Context extends MathexprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitMath2(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MultDivContext extends Mathexpr2Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitMultDiv(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class Math3Context extends Mathexpr2Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitMath3(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Log4Context extends Mathexpr3Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitLog4(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class PowContext extends Mathexpr3Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitPow(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NegateContext extends Logexpr4Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitNegate(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValueContext extends Logexpr4Context {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitValue(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ValIdContext extends ValContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitValId(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValNumberContext extends ValContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitValNumber(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValFunccallPrintContext extends ValContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitValFunccallPrint(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValParenthesisedExprContext extends ValContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitValParenthesisedExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValFunccallContext extends ValContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitValFunccall(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValBooleanContext extends ValContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitValBoolean(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunccallContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitFunccall(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprparamsEmptyContext extends ExprparamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitExprparamsEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ExprparamsNotEmptyContext extends ExprparamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitExprparamsNotEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprmoreparamsNotEmptyContext extends ExprmoreparamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitExprmoreparamsNotEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ExprmoreparamsEmptyContext extends ExprmoreparamsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BVisitor ) return ((BVisitor<? extends T>)visitor).visitExprmoreparamsEmpty(this);
			else return visitor.visitChildren(this);
		}
	}
